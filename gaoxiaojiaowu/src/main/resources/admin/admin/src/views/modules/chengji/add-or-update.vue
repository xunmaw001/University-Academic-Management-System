    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="系部" prop="xibuValue">
                        <el-input v-model="yonghuForm.xibuValue"
                                  placeholder="系部" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="chengjiName">
                       <el-input v-model="ruleForm.chengjiName"
                                 placeholder="标题" clearable  :readonly="ro.chengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="chengjiName">
                           <el-input v-model="ruleForm.chengjiName"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="得分" prop="chengjiNumber">
                       <el-input v-model="ruleForm.chengjiNumber"
                                 placeholder="得分" clearable  :readonly="ro.chengjiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="得分" prop="chengjiNumber">
                           <el-input v-model="ruleForm.chengjiNumber"
