<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
					<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.jiaowutongzhiName}}
					</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					<view class="detail-list-item"
						...
						<view class="text" :style='{"color":"#4477C5","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.jiaowutongzhiValue}}</view>
					</view>
			</view>
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.jiaowutongzhiContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('jiaowutongzhi', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.jiaowutongzhiPhoto ? this.detail.jiaowutongzhiPhoto.split(",") : [];
			},
