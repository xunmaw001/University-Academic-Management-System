		...
		<form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.kebiaoName" type="text" v-model="ruleForm.kebiaoName" placeholder="标题"></input>
            </view>
                ...
                <view
                        ...
                        class="cu-form-group" @tap="kebiaoPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#4477C5","textAlign":"left"}'
                          class="title">课表上传</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.kebiaoPhoto" :src="ruleForm.kebiaoPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#4477C5","borderRadius":"0px","color":"#4477C5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","height":"200rpx"}'
                          :disabled="ro.kebiaoContent" v-model="ruleForm.kebiaoContent" placeholder="课程详情"/>
            </view>
	...
	export default {
		...
		/*下拉框*/
			...
			if (options.id) {
				...
				// 获取信息
				let res = await this.$api.info(`kebiao`, this.ruleForm.id);
				this.ruleForm = res.data;
			}
			if(options.kebiaoId){
                this.ruleForm.kebiaoId = options.kebiaoId;
			}
			// 跨表
			// this.styleChange()
		},
		methods: {
			...
			kebiaoPhotoTap() {
				...
				this.$api.upload(function(res) {
					_this.ruleForm.kebiaoPhoto = _this.$base.url + 'upload/' + res.file;
					_this.$forceUpdate();
					_this.$nextTick(() => {
						// _this.styleChange()
					})
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.kebiaoPhoto)) {
					this.$utils.msg(`课表上传不能为空`);
					return
				}
				if (this.ruleForm.id) {
					await this.$api.update(`kebiao`, this.ruleForm);
				} else {
					await this.$api.save(`kebiao`, this.ruleForm);
				}
